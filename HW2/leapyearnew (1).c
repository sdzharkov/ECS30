...
//function that computes whether or not the year is a leap year
void is_leap_year(int user_input) { //no value needs to be returned because there are print statements
...
int main() {
	...
	is_leap_year(user_input); //call the function that calculates if the year is a leap year
