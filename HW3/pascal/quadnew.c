...
//function that calculates the roots of the quadratic equation and prints out the roots
//uses the quadratic formula to solve for roots
void calculate_roots(double a, double b, double c) { //void function because does not need to return any values
...
int main() {
	...
	calculate_roots(a,b,c); //call the function to calculate the roots of the quadratic equation
